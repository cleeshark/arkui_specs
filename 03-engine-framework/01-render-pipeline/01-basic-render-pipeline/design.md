...
| 关联 Epic | 无 |
| 目标 Feature | Feat-01 渲染主流程；Feat-02 Build 阶段细化（规划）；Feat-03 Layout 阶段细化（规划）；Feat-04 Render 阶段与渲染树同步 |
| 复杂度 | 复杂 |
