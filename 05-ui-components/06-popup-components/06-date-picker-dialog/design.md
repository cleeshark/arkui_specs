...
| 字段 | 内容 |
|---|---|
| Design ID | DESIGN-Func-05-06-06 |
| 关联需求 | 已有能力补录（无独立 requirement.md） |
| 关联 Epic | 无 |
| 目标 Feature | Feat-01 DatePickerDialog 完整能力 |
| 复杂度 | 关键 |
...
| 仓库 | 补充架构说明 |
|---|---|
| interface/sdk-js/api | interface/sdk-js/api/@internal/component/ets/date_picker.d.ts / interface/sdk-js/api/arkui/component/datePicker.static.d.ets |
| ace_engine/frameworks/core/components_ng/pattern | frameworks/core/components_ng/pattern/date_picker/bridge/date_picker_dialog_extender.cpp:312 |
...
| 层 | 模块 | 职责 | 修改类型 |
|---|---|---|---|
| ArkTS API | DatePickerDialog.show(options?) / UIContext.showDatePickerDialog | 接收 options 和 callbacks | 文档补录 |
| Bridge/Extender | frameworks/core/components_ng/pattern/date_picker/bridge/date_picker_dialog_extender.cpp:312 | 转换 DialogProperties/SettingData/事件 | 文档补录 |
| Model | frameworks/core/components_ng/pattern/date_picker/datepicker_model_ng.cpp:765 | 选择 NG 实现并请求显示 | 文档补录 |
...
| Task ID | 目标 | 受影响文件 | AC |
|---|---|---|---|
| TASK-SKELETON-1 | Feat-01 DatePickerDialog 完整能力 | Feat-01-date-picker-dialog-spec.md | 见对应 spec |

## 后续 Task 拆分

| Task ID | 目标 | 受影响文件 | 依赖 |
|---|---|---|---|
| TASK-050606-01 | Feat-01 DatePickerDialog 完整能力 | Feat-01-date-picker-dialog-spec.md | 源码与 SDK 契约 |
...
|---|---|---|---|---|---|
| DatePickerDialog.show(options?) / UIContext.showDatePickerDialog | Public | ArkUI | interface/sdk-js/api/@internal/component/ets/date_picker.d.ts / interface/sdk-js/api/arkui/component/datePicker.static.d.ets | enableHapticFeedback 场景需 VIBRATE | SystemCapability.ArkUI.ArkUI.Full |

### 变更/废弃 API

| 原有 API | 变更类型 | 新 API | 迁移说明 |
|---|---|---|---|
| DatePickerDialog.show(options?) | 废弃 since 18 | UIContext.showDatePickerDialog | 迁移到绑定正确 UI 实例的 UIContext |
...
```mermaid
graph TB
    L1["ArkTS API<br/>DatePickerDialog.show(options?) / UIContext.showDatePickerDialog"]
    L2["Bridge/Extender<br/>frameworks/core/components_ng/pattern/date_picker/bridge/date_picker_dialog_extender.cpp:312"]
    L3["Model<br/>frameworks/core/components_ng/pattern/date_picker/datepicker_model_ng.cpp:765"]
...
|---|---|---|---|---|
| 1 | DatePickerDialog.show(options?) / UIContext.showDatePickerDialog | frameworks/core/components_ng/pattern/date_picker/bridge/date_picker_dialog_extender.cpp:312 | 接收 options 和 callbacks | 沿现有链路传递 |
| 2 | frameworks/core/components_ng/pattern/date_picker/bridge/date_picker_dialog_extender.cpp:312 | frameworks/core/components_ng/pattern/date_picker/datepicker_model_ng.cpp:765 | 转换 DialogProperties/SettingData/事件 | 沿现有链路传递 |
| 3 | frameworks/core/components_ng/pattern/date_picker/datepicker_model_ng.cpp:765 | components_ng picker dialog view / OverlayManager | 选择 NG 实现并请求显示 | 沿现有链路传递 |
...
|---|---|---|---|---|---|
| DatePickerDialog.show(options?) / UIContext.showDatePickerDialog | options | DialogOptions | SDK 定义范围 | 无效可选字段按 converter 默认/忽略 | 字段按 @since 生效 |
...
实现证据：`frameworks/core/components_ng/pattern/date_picker/bridge/date_picker_dialog_extender.cpp:312`。
### Model 收敛

转换结果进入 picker DialogModel，再由 DialogView/OverlayManager 创建弹窗。

实现证据：`frameworks/core/components_ng/pattern/date_picker/datepicker_model_ng.cpp:765`。
### Static 接口边界
