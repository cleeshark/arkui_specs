...
| 字段 | 内容 |
|---|---|
| Design ID | DESIGN-Func-05-06-05 |
| 关联需求 | 已有能力补录（无独立 requirement.md） |
| 关联 Epic | 无 |
| 目标 Feature | Feat-01 CalendarPickerDialog 完整能力 |
| 复杂度 | 关键 |
...
| 仓库 | 补充架构说明 |
|---|---|
| interface/sdk-js/api | interface/sdk-js/api/@internal/component/ets/calendar_picker.d.ts / interface/sdk-js/api/arkui/component/calendarPicker.static.d.ets |
| ace_engine/frameworks/core/components_ng/pattern | frameworks/core/components_ng/pattern/calendar_picker/bridge/arkts_native_calendar_picker_dialog_bridge.cpp:811 |
...
| 层 | 模块 | 职责 | 修改类型 |
|---|---|---|---|
| ArkTS API | CalendarPickerDialog.show(options?) | 接收 options 和 callbacks | 文档补录 |
| Bridge/Extender | frameworks/core/components_ng/pattern/calendar_picker/bridge/arkts_native_calendar_picker_dialog_bridge.cpp:811 | 转换 DialogProperties/SettingData/事件 | 文档补录 |
| Model | frameworks/core/components_ng/pattern/calendar_picker/calendar_dialog_view.cpp:1195 | 选择 NG 实现并请求显示 | 文档补录 |
...
| Task ID | 目标 | 受影响文件 | AC |
|---|---|---|---|
| TASK-SKELETON-1 | Feat-01 CalendarPickerDialog 完整能力 | Feat-01-calendar-picker-dialog-spec.md | 见对应 spec |

## 后续 Task 拆分

| Task ID | 目标 | 受影响文件 | 依赖 |
|---|---|---|---|
| TASK-050605-01 | Feat-01 CalendarPickerDialog 完整能力 | Feat-01-calendar-picker-dialog-spec.md | 源码与 SDK 契约 |
...
|---|---|---|---|---|---|
| CalendarPickerDialog.show(options?) | Public | ArkUI | interface/sdk-js/api/@internal/component/ets/calendar_picker.d.ts / interface/sdk-js/api/arkui/component/calendarPicker.static.d.ets | enableHapticFeedback 场景需 VIBRATE | SystemCapability.ArkUI.ArkUI.Full |

### 变更/废弃 API

| 原有 API | 变更类型 | 新 API | 迁移说明 |
|---|---|---|---|
| CalendarPickerDialog.show(options?) | 无 | N/A | CalendarPickerDialog 当前无 UIContext 等价入口 |
...
```mermaid
graph TB
    L1["ArkTS API<br/>CalendarPickerDialog.show(options?)"]
    L2["Bridge/Extender<br/>frameworks/core/components_ng/pattern/calendar_picker/bridge/arkts_native_calendar_picker_dialog_bridge.cpp:811"]
    L3["Model<br/>frameworks/core/components_ng/pattern/calendar_picker/calendar_dialog_view.cpp:1195"]
...
|---|---|---|---|---|
| 1 | CalendarPickerDialog.show(options?) | frameworks/core/components_ng/pattern/calendar_picker/bridge/arkts_native_calendar_picker_dialog_bridge.cpp:811 | 接收 options 和 callbacks | 沿现有链路传递 |
| 2 | frameworks/core/components_ng/pattern/calendar_picker/bridge/arkts_native_calendar_picker_dialog_bridge.cpp:811 | frameworks/core/components_ng/pattern/calendar_picker/calendar_dialog_view.cpp:1195 | 转换 DialogProperties/SettingData/事件 | 沿现有链路传递 |
| 3 | frameworks/core/components_ng/pattern/calendar_picker/calendar_dialog_view.cpp:1195 | components_ng picker dialog view / OverlayManager | 选择 NG 实现并请求显示 | 沿现有链路传递 |
...
|---|---|---|---|---|---|
| CalendarPickerDialog.show(options?) | options | CalendarDialogOptions | SDK 定义范围 | 无效可选字段按 converter 默认/忽略 | 字段按 @since 生效 |
...
实现证据：`frameworks/core/components_ng/pattern/calendar_picker/bridge/arkts_native_calendar_picker_dialog_bridge.cpp:811`。
### Model 收敛

转换结果进入 picker DialogModel，再由 DialogView/OverlayManager 创建弹窗。

实现证据：`frameworks/core/components_ng/pattern/calendar_picker/calendar_dialog_view.cpp:1195`。
### Static 接口边界
